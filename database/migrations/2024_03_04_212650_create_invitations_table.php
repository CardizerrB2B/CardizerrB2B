...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('invitations', function (Blueprint $table) {
            $table->id();
            $table->integer('distributor_id')->unsigned()->nullable(); // who created the invitation for his marchents
            ...
            $table->integer('used_by_id')->unsigned()->nullable(); // if the invitation is used by a marchent
